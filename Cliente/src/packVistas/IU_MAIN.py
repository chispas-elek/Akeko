...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("plasma-next-icons/Breeze/actions/toolbar/user-group-properties.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bGestionarScripts.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("plasma-next-icons/Breeze/actions/toolbar/configure-shortcuts.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bCambiarNombre.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("plasma-next-icons/Breeze/actions/toolbar/edit-delete-shred.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bEliminarGrupo.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("plasma-next-icons/Breeze/actions/toolbar/resource-group-new.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAnadirGrupo.setIcon(icon7)
        self.actionAnadirGrupo.setObjectName("actionAnadirGrupo")
        self.actionVerHistorial = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("plasma-next-icons/Breeze/actions/toolbar/cartesian-plot-four-axes.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionVerHistorial.setIcon(icon8)
        self.actionVerHistorial.setObjectName("actionVerHistorial")
        self.actionCerrarSesion = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("plasma-next-icons/Breeze/actions/toolbar/application-exit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCerrarSesion.setIcon(icon9)
        self.actionCerrarSesion.setObjectName("actionCerrarSesion")
        self.actionGestionar_Mis_Tags = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("plasma-next-icons/Breeze/actions/toolbar/milestone.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGestionar_Mis_Tags.setIcon(icon10)
